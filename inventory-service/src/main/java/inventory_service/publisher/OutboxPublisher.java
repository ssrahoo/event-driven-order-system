package inventory_service.publisher;
...
public class OutboxPublisher {
    ...
    public void publishEvents() {
        List<OutboxEvent> events = outboxRepository.findTop100ByProcessedFalseAndEventTypeStartingWithOrderByCreatedAtAsc("INVENTORY");
